...
```text
รับค่าสีออกมาสองสี แล้วเก็บค่าเข้าdict เสร็จแล้วก็เข้่าเงื่อนไขว่าสีนี้ผสมกับสีนั้นแล้วจะได้สีอะไร เขียนตามเงื่อนไขที่โจทย์กำหนดไว้
```
...
```text
Step 1:เขียนinputสองตัว รับค่าเป็นstrแล้วนำอินพุตไปเก็บในdict
Step 2:เข้าเงื่อนไขว่าถ้าในdictมีสีนี้และสีนั้นจะผสมออกมาได้สี.....โดยกำหนดสีoutputจากโจทย์ที่กำหนด
```
...
```text
เพิ่มเติมจากSection 3โดยเติมว่าสีเดียวกันผสมกันจะได้สีเดิม
```
...
```text
อยากรู้ว่าสีเดียวกันจะเป็นแบบไหน
```
